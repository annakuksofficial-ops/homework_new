...
В проект добавлено логирование в модуле masks и utils для отслеживания работы функций

## Работа с CSV и Excel файлами

Добавлена поддержка чтения финансовых операций из файлов разных форматов.

### Модуль `file_readers.py`

#### Функция `read_csv_file(file_path)`
- Читает транзакции из CSV файла
- Принимает путь к файлу в качестве аргумента
- Возвращает список словарей с транзакциями
- Разделитель в CSV - точка с запятой (;)
- Пустые значения автоматически удаляются из результата
